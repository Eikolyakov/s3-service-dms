package ru.vsk.s3servicedms.services.minio;
...
import ru.vsk.s3servicedms.services.minio.exceptions.MinioFetchException;
...
public class MinioService {
     ...
     * @throws MinioException if an error occur while uploading object
     */
    public void upload(Path source, InputStream file, String contentType, String bucket) throws MinioException {
        try {
            PutObjectArgs args = PutObjectArgs.builder()
                    .bucket(bucket)
                    .object(source.toString())
            ...
            throw new ResponseStatusException(
                    HttpStatus.BAD_REQUEST, "Failed to upload", e);
        } catch (Exception e) {
            throw new MinioException("Error while fetching files in Minio", e);
        }
    }
